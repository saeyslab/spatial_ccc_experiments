// allen_brain_atlas_via_pooch build-main
// 
...
meta = [
  ...
  "functionality" : {
    "name" : "allen_brain_atlas_via_pooch",
    "version" : "build-main",
    "arguments" : [
      {
        "type" : "file",
      ...
      },
      {
        ...
        "description" : "Brain section label",
        "example" : [
          "Zhuang-ABCA-1.080"
        ],
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/spatial_ccc_experiments/spatial_ccc_experiments/src/dataset_loaders/allen_brain_atlas_via_pooch/"
      }
    ],
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/spatial_ccc_experiments/spatial_ccc_experiments/src/dataset_loaders/allen_brain_atlas_via_pooch/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "target/nextflow/allen_brain_atlas_via_pooch",
    "viash_version" : "0.8.6",
    "git_commit" : "57df20b61407666ecc453106abffe23611f5759b",
...
par = {
  ...
  'brain_section_label': $( if [ ! -z ${VIASH_PAR_BRAIN_SECTION_LABEL+x} ]; then echo "r'${VIASH_PAR_BRAIN_SECTION_LABEL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "saeyslab/spatial_ccc_experiments/allen_brain_atlas_via_pooch",
    "tag" : "build-main"
  },
  "tag" : "$id"
}'''),
